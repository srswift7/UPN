...
'                    3.19 Normale Idx-Funktion in der Eingabe wiederhergestellt
'                    3.20 Pause mit Parameter (s)
'                    3.21 Small cleanup
'                    3.22 Speedup to 8 MHz
'                    3.23 Finetuning der UART-Funktionen
'
'----------------------------------------------------------
...
$crystal = 8000000                                          ' Kein Quarz: 1MHz MHz
...
Sub Upload_block()
   ...
   If Akt_bl = F_nextblock Then
       ...
       ' Wenn Es Der Block 0 War , Wissen Wir Jetzt Einige Steuerdaten
...
Function Read_block(nextblock As Byte) As Byte
   ...
   If G_uart_error = 0 Then                                 ' Sauber gelesen
      For I = 1 To 10
